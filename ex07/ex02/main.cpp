...
/*   Updated: 2024/02/28 11:38:43 by hed-dyb          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "A1 : size = " << A1.getSize() << ",  Data : ";
	std::cout << A1[0] << " " << A1[1] << " " << A1[2] << std::endl;
	
	std::cout << "A2 : size = " << A2.getSize() << ",  Data : ";
...
int main ()
{
	...
	Array<int> A1(3);  
	for(unsigned int i = 0; i < A1.getSize(); i++)
		A1[i] = i * 100;
	Array<int> A2(A1); 
	Array<int> A3; 
	A3 = A1;
	...
	// 	for (unsigned int i = 0; i < A.getSize() ; i++)
	// 		A[i] = i * 10;
	// 	for (unsigned int i = 0; i < A.getSize() + 32433; i++)
	// 		std::cout << A[i] << std::endl;
	// }
